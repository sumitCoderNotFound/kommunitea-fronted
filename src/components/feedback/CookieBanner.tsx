...
export function CookieBanner() {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 z-[80] mx-auto max-w-2xl rounded-2xl border border-sand-border bg-sand-card p-4 shadow-lift sm:flex sm:items-center sm:gap-4">
